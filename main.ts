...
enum DlbitRGBPixelMode {
    ...
    */
    ...
    function create(pin: DigitalPin, numleds: number, mode: DlbitRGBPixelMode): LHDlbitRGBLight {
    ...
    let lhRGBLight: LHDlbitRGBLight;
    let lhRGBLight_:LHDlbitRGBLight;
    ...
    export function initRGBLight(rgb_id: RGB, dataPin: DigitalPin) {
        ...
        if (rgb_id == RGB.RGB1) {
            ...
            if (!lhRGBLight) {
                lhRGBLight = create(dataPin, 1, DlbitRGBPixelMode.RGB);
            ...
            if (!lhRGBLight_) {
                lhRGBLight_ = create(dataPin, 1, DlbitRGBPixelMode.RGB);
                lhRGBLight_.clear();
            }
        }
